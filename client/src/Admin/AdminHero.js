  ...
  return (
    ...
    <Navbar/>
                 ...
                 <section
                      ...
                      <button className='bg-[#0BA75A] text-white px-5 py-3 rounded-sm mt-7 hover:bg-[#1d623f]'><Link to='/createhostel'>Create Hostel</Link></button>
                      <button className='bg-[#CFA146] text-white px-5 ml-5 py-3 rounded-sm mt-7 hover:bg-[#8e6d2c]'><Link to='/createroom'>Create Room</Link></button>
                      </div>
                </section>
