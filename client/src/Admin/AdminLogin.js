                ...
                <div className='w-full h-[800px] flex justify-center items-center'>
                    <div className=' flex flex-col gap-[30px]'>    
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <div class=" text-zinc-800 text-[25px] font-semibold font-['Inter'] leading-[38.09px]">Welcome Back</div>
                        </div>
                        <div className='flex flex-col pt-[20px] gap-9'>
                            <div className='flex flex-col gap-2'>
                                <p className='text-[14px] text-[#425466]'>Admin Email</p>
                                <input type="text" placeholder='admin2bouesti@gmail.com' className='w-[280px] px-4 py-2 placeholder-sm rounded-md shadow outline-none'/>
                            </div>
                            ...
                            <Link to ='/login' className='text-sm text-[#0BA75A]'>Student</Link>
                            <Link to='/adminhostel' className='py-3 bg-[#0BA75A] text-white font-semibold text-sm rounded-[10px] text-center hover:bg-[#1d623f] hover:translate-y-2 hover:transition-transform'>Login</Link>
