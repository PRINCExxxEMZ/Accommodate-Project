            ...
            <div className='w-full h-screen px-10 flex flex-col'>
                <div className='w-full h-[800px] flex justify-center items-center'>
                    <div className=' flex flex-col gap-[30px]'>    
                        ...
                        <div className='flex flex-col pt-[10px] gap-6'>
                            <div className='flex flex-col gap-2'>
                                <p className='text-[14px] text-[#425466]'>Name</p>
                                <input type="text" placeholder='Adeoye Emmanel' className='w-[280px] px-4 py-2 placeholder-sm rounded-md shadow outline-none'/>
                            </div>
                            <div className='flex flex-col gap-2'>
                                <p className='text-[14px] text-[#425466]'>Jamb registreaction number</p>
                                <input type="password" placeholder='2356743DF'  className='w-full  px-4 py-2 placeholder-sm rounded-md shadow outline-none'/>
                            </div>

                            <div className='flex flex-col gap-2'>
                                <p className='text-[14px] text-[#425466]'>Jamb registreaction email</p>
                                <input type="password" placeholder='adeoyeemmanuel@gmail.com'  className='w-full  px-4 py-2 placeholder-sm rounded-md shadow outline-none'/>
                            </div>
                            ...
                            <Link to='/register' className='text-sm text-[#0BA75A]'>Register</Link>
