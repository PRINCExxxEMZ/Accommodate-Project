...
const Hero = () => {
 ...
 <section
            ...
            <div className="w-[316px] top-1/2 transform -translate-y-1/2 absolute z-20 md:w-[450px] mx-5 lg:mx-10 lg:w-[562px]">
               <h1 className='font-bold text-[25px] text-white lg:text-[35px]'>Ease into University Life with Our Convenient Accommodation </h1>
                <p className='text-white text-[16px] lg:text-[20px]'>Experience a vibrant community, cozy living spaces,and all the
                  essentials for a great student life. Welcome to your home away from home.</p>
